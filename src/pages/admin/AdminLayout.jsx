...
import { LayoutDashboard, Package, ShoppingCart, Droplets, Settings, ArrowLeft, Shield, Menu, X, FileImage, Megaphone } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const links = [
    ...
    { to: '/admin/alerts', icon: Megaphone, label: lang === 'hi' ? 'अलर्ट और घोषणाएं' : 'Alerts & Broadcasts' },
